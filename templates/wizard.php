...
<a id="closeWizard" class="close">
	<img class="svg" src="<?php print_unescaped(image_path('core', 'actions/close.svg')); ?>">
</a>
...
<a target="_blank" href="<?php p($_['clients']['android']); ?>">
	<img src="<?php print_unescaped(image_path('core', 'googleplay.svg')); ?>"
...
<a target="_blank" class="button" href="<?php p(link_to_docs('user-webdav')); ?>">
	<img class="appsmall svg" alt=""
		src="<?php print_unescaped(image_path('files', 'folder.svg')); ?>" />
