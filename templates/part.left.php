...
<img src="<?php print_unescaped(image_path('core', 'desktopapp.png')); ?>"
...
<img src="<?php print_unescaped(image_path('core', 'appstore.png')); ?>"
...
<?php if ($_['edition'] === ''): ?>
	...
	<a target="_blank" class="button" href="<?php p(link_to_docs('user-sync-calendars')) ?>">
		<img class="appsmall appsmall-calendar svg" alt=""
			 src="<?php print_unescaped(image_path('core', 'places/calendar-dark.svg')); ?>" />
	...
	<a target="_blank" class="button" href="<?php p(link_to_docs('user-sync-contacts')) ?>">
		<img class="appsmall appsmall-contacts svg" alt=""
			 src="<?php print_unescaped(image_path('core', 'places/contacts-dark.svg')); ?>" />
	...
	<a target="_blank" class="button" href="<?php p(link_to_docs('user-webdav')); ?>">
		<img class="appsmall svg" alt=""
			 src="<?php print_unescaped(image_path('core', 'places/folder.svg')); ?>" />
	<?php p($l->t('Access files via WebDAV')); ?>
	</a>
<?php else: ?>
	<br><br><br>
	<a target="_blank" class="button" href="<?php p(link_to_docs('user-manual')); ?>">
		<img class="appsmall svg" src="<?php print_unescaped(image_path('settings', 'help.svg')); ?>" /> <?php p($l->t('Documentation')); ?>
	</a>
	<a target="_blank" class="button" href="<?php p(link_to_docs('user-webdav')); ?>">
		<img class="appsmall svg" src="<?php print_unescaped(image_path('core', 'places/folder.svg')); ?>" /> <?php p($l->t('Access files via WebDAV')); ?>
	</a>
<?php endif; ?>