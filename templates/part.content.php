<div id="firstrunwizard-content">
	...
	<?php if (1 === 1): ?>
		<h2>
			<?php p($l->t('Take time to enter or update your personal information.')); ?>
		</h2>
		<?php if ($_['displayName'] !== null): ?>
			<form id="wizarddisplaynameform">
				<h3>
					<label for="wizarddisplayname"><?php p($l->t('Full name')) ?></label>
				</h3>
				<input type="text" id="wizarddisplayname" name="wizarddisplayname"
					   value="<?php p($_['displayName']) ?>"
					   autocomplete="on" autocapitalize="off" autocorrect="off" />
				<span class="msg"></span>
				<input type="hidden" id="oldwizarddisplayname" name="oldwizarddisplayname" value="<?php p($_['displayName']) ?>" />
			</form>
		<?php endif; ?>

		<?php if ($_['email'] !== null): ?>
			<form id="wizardemailform">
				<h3><label for="wizardemail"><?php p($l->t('Email')); ?></label></h3>
				<input type="email" name="wizardemail" id="wizardemail" value="<?php p($_['email']); ?>"
					   placeholder="<?php p($l->t('Your email address')); ?>"
					   autocomplete="on" autocapitalize="off" autocorrect="off" />
				<span class="msg"></span><br />
				<input type="hidden" id="oldwizardemail" name="oldwizardemail" value="<?php p($_['email']) ?>" />
			</form>
		<?php endif; ?>
